...
import { FiLogOut, FiMenu, FiSearch, FiX, FiBell, FiMoon, FiSun } from 'react-icons/fi';
  ...
  return (
    <div className="flex min-h-screen bg-surface-muted font-sans text-ink">
      ...
      <div className="flex min-h-screen flex-1 flex-col lg:ml-64">
        <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-line bg-surface-elevated/95 px-4 backdrop-blur sm:px-6">
          <button
            type="button"
          ...
          <h1 className="shrink-0 text-lg font-bold text-ink sm:text-xl">{pageTitle}</h1>
          ...
          <div className="mx-auto hidden max-w-xl flex-1 lg:block">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-full border border-line bg-field py-2 pl-10 pr-4 text-sm text-ink placeholder:text-ink-muted focus:border-emerald-600 focus:outline-none focus:ring-1 focus:ring-emerald-600"
              />
            </div>
          </div>
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            ...
            <Link
              ...
              className="relative rounded-full p-2 text-ink-muted hover:bg-chip hover:text-ink"
